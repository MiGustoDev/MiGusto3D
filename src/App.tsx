          ...
          <div style={{
            ...
            {/* DERECHA: Instagram */}
              <div style={{display: 'flex', alignItems: 'center', gap: 8, color: '#FFD700'}}>
                ...
                <a href="/x3d" style={{marginLeft: 16, color: '#FFD700', fontWeight: 700, textDecoration: 'none', fontSize: '1rem', border: '1.5px solid #FFD700', borderRadius: 12, padding: '0.4rem 1.1rem', background: 'rgba(255,215,0,0.08)', transition: 'background 0.2s'}}>Ver en 3D</a>
            </div>
          </div>
        ) : (
          <>
